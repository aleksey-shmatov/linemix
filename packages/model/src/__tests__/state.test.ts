...
describe('applyEvent', () => {
  it('should add a stroke', () => {
    ...
    const event: DocEvent = {
      id: '1' as any,
      kind: 'stroke_added',
      stroke: { id: 'stroke_1' as any, points: [], authorId: 'a1' as any, schemaVersion: 1, color: 'black', width: 1 },
      authorId: 'a1' as any,
      at: Date.now()
    };
  ...
  it('should remove a stroke', () => {
    const initialState = { strokes: [{ id: 'stroke_1' as any, points: [], authorId: 'a1' as any, schemaVersion: 1 as const, color: 'black', width: 1 }] };
    const event: DocEvent = {
      id: '2' as any,
      kind: 'stroke_removed',
