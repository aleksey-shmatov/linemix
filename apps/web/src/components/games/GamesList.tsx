...
export function GamesList() {
    ...
    return (
        <main className="mx-auto max-w-md space-y-6 p-8">
            ...
            {create.error && <p className="text-sm text-red-600">Couldn&apos;t create game. Try again.</p>}
                    ...
                    return (
                        <li key={g.id}>
                            {pending ? (
                                ...
                                <Link href={`/game/${g.id}`} className="block rounded border px-3 py-2 hover:bg-neutral-50">
                                    {g.name}
                                </Link>
                            )}
                        </li>
